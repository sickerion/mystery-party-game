...
def sanitize_prompt_with_ai(theme: str, language: str) -> str:
    """
    Use Claude AI to sanitize theme, removing sensitive words
...
def generate_cover_image(game_id: str, theme: str, language: str = "en") -> str:
    """
    ...
    sanitized_description = sanitize_prompt_with_ai(theme, language)
